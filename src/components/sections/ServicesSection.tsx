      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {services.map((service) => (
            <div 
              key={service.title} 
              className="p-10 transition-all bg-[#1b5e4c] text-white shadow-xl hover:shadow-2xl hover:-translate-y-1 duration-300"
            >
              <div className="mb-8 h-12 w-12 flex items-center justify-center p-2 rounded-none bg-secondary text-[#1b5e4c]">
                {service.icon}
              </div>
